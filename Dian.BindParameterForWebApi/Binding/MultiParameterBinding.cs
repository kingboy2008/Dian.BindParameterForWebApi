...
namespace Dian.BindParameterForWebApi.Binding
{
    ...
    /// with <see cref="MultiParametersAttribute"/> and supports HTTP POSTs, clients must pass
    ...
    ///		[MultiParameters] public string MyMethod(CustomObject param1, CustomObject param2, string param3) { ... }
    ///		
    ...
    ///		param1=...&amp;param2=...&amp;param3=...
    ///		
    /// To use this class, Call this method in WebApiConfig.cs in Register :
    ///		config.ParameterBindingRules.Insert(0, MultiParameterBinding.CreateBindingForMarkedParameters);
    /// 
    /// </remarks>
    public class MultiParameterBinding : HttpParameterBinding
	{

		public MultiParameterBinding(HttpParameterDescriptor descriptor)
			: base(descriptor)
		{ }
        ...
        /// <summary>
        /// Returns a <see cref="MultiParameterBinding"/> object to use for the API method parameter specified.
        /// An object is only returned if the parameter's method is marked with <see cref="MultiParametersAttribute"/>,
        ...
        ///		config.ParameterBindingRules.Insert(0, MultiParameterBinding.CreateBindingForMarkedParameters);
        /// </remarks>
        public static MultiParameterBinding CreateBindingForMarkedParameters(HttpParameterDescriptor descriptor)
		{
			// short circuit if action does not have this attribute
			if (!descriptor.ActionDescriptor.GetCustomAttributes<MultiParametersAttribute>().Any(x => x.Enabled))
				return null;
